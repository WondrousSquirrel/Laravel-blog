  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <div class="box box-primary">
            ...
            <!-- action важен для чего мы применяем эту форму. enctype - необходим для загрузки изображений-->
          ...
          <div class="form-group">
                    ...
                    <a href="{{ route('post.index') }}" class="btn btn-primary" role="button" >Back</a>
                  </div>
          </form>
        </div>
